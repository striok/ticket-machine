...
class StartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create start" do
    assert_difference('Start.count') do
      post starts_url, params: { start: { picture_url: @start.picture_url, title: @start.title } }
    end
  ...
  test "should update start" do
    patch start_url(@start), params: { start: { picture_url: @start.picture_url, title: @start.title } }
